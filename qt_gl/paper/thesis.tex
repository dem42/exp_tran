...
$\gamma$. The perspective projection is therefore ill-suited for optimization, since the $\gamma$ will be equal to the unknown value of $z$-component
of $\mathbf{p}_i$. The derivative of the error function will therefore be
a non-linear function because the error depends on the $\gamma$. 
