...
\subsection{Computing the HOSVD !!NOT SURE}\label{s:hosvd}
...
\subsection{Minimizing the Error Function !CRUCIAL}\label{s:minerror}
...
\subsection{Overfitting !CRUCIAL}\label{s:overfitting}
...
\subsection{Fitting Algorithm !CRUCIAL}\label{s:fitalgo}
...
\chapter{Results and Evaluation !NEW}
