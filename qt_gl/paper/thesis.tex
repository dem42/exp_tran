...
{ \huge \bfseries Tensor-based Modelling of Deformable Face Shapes}\\[1cm]
\LARGE by\\[1cm]
...
that define the shape or texture of his or her face. The ultimate goal is to be
able to capture
...
recording. The application allows the user to separately manipulate the identity and
