...
its application was compiled by De Lathauwer in \cite{multilinear}.
...
\subsubsection{Tensor-Based Model >>>>> ALTERED <<<<<<<}\label{works}
...
an object from a 2D image of the object. The problem is specified as follows -
...
\chapter{Design and Implementation >>>>> NEW <<<<<}\label{design}
