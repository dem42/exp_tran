...
the image. During the selection process, he is guided with a label which informs
him which feature point he should select next. This design is shown in figure
\ref{fg:featurePoints2}.

\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.50]{images/featureSelection.png}
\par\end{centering}
...
The parameters of this camera model must be obtained by calibrating the camera which
was used to capture the image. Since calibration can only be performed if the
